outposts = {
    ...
    [9] = {name = "Vespucci Timber", status = 0, factionID = 0, blipX = -1125.21, blipY = -964.62, blipZ = 12.85, x1 = -1125.02, y1 = -971.46, z1 = 1.15, x2 = -1130.67, y2 = -956.27, z2 = 7.73, x3 = -1098.37, y3 = -944.87, z3 = 14.01, rx = 0.0, ry = 0.0, rz = 125.96, xp = "", cash = ""},
    [10] = {name = "Otto's Autoshop", status = 0, factionID = 0, blipX = 808.99, blipY = -820.52, blipZ = 36.08, x1 = 826.63, y1 = -813.32, z1 = 26.31, x2 = 814.65, y2 = -810.25, z2 = 33.08, x3 = 782.63, y3 = -825.82, z3 = 35.91, rx = 0.0, ry = 0.0, rz = 293.26, xp = "", cash = ""},
}
...
enemySpawns = {
    ...
    [5] = {
        ...
        {handle = 0, x = 426.06, y = -980.435, z = 30.71, h = 81.734},
        {handle = 0, x = 440.604, y = -975.723, z = 30.68, h = 11.001},
        {handle = 0, x = 440.247, y = -982.681, z = 30.68, h = 88.33},
        {handle = 0, x = 455.533, y = -986.31, z = 30.68, h = 268.56},
        {handle = 0, x = 470.301, y = -985.199, z = 33.89, h = 96.168},
    ...
    [8] = {
        {handle = 0, x = -324.091, y = -1536.05, z = 35.87, h = 301.52},
        {handle = 0, x = -336.17, y = -1535.82, z = 35.85, h = 48.93},
        {handle = 0, x = -353.75, y = -1531.13, z = 34.25, h = 79.71},
        {handle = 0, x = -335.01, y = -1515.59, z = 27.56, h = 209.39},
        {handle = 0, x = -321.16, y = -1545.88, z = 31.01, h = 268.96},
        {handle = 0, x = -344.41, y = -1544.95, z = 27.72, h = 178.52},
    ...
    [10] = {
        {handle = 0, x = 799.44, y = -808.15, z = 26.18, h = 62.01},
        {handle = 0, x = 801.58, y = -819.44, z = 26.18, h = 92.51},
        {handle = 0, x = 815.47, y = -820.96, z = 26.18, h = 196.79},
        {handle = 0, x = 823.03, y = -808.27, z = 26.31, h = 311.04},
        {handle = 0, x = 791.22, y = -802.49, z = 40.23, h = 163.91},
        {handle = 0, x = 809.15, y = -807.14, z = 31.01, h = 104.46},
        {handle = 0, x = 813.61, y = -815.69, z = 31.01, h = 154.85},
    },
}
